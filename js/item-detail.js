import { getWeaponStats, getArmorStats } from './data.js?v=2.1.0';
import { rarityClass, optionDisplayName, formatOptionValue, showToast } from './utils.js?v=2.1.0';
import { isSupabaseReady, getRatingSummary, fetchItemRatings, submitRating, updateRating, deleteRating, hasAlreadyRated } from './supabase.js?v=2.1.0';
import { renderStars } from './render.js?v=2.1.0';
